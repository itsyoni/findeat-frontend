  ...
  return (
    <View>
      ...
      <View className="gap-4">
        <TextInput useBottomSheetInput={useBottomSheetInput} value={email} onChangeText={setEmail} editable={!requested} placeholder={t('email')} keyboardType="email-address" autoCapitalize="none" className="border-0 bg-[#f8f8f8] dark:bg-gray-900" />
        {requested ? <>
          <TextInput useBottomSheetInput={useBottomSheetInput} value={code} onChangeText={(value) => setCode(value.replace(/\D/g, '').slice(0, 6))} placeholder={t('verificationCode')} keyboardType="number-pad" maxLength={6} className="border-0 bg-[#f8f8f8] dark:bg-gray-900" />
          <TextInput useBottomSheetInput={useBottomSheetInput} value={password} onChangeText={setPassword} placeholder={t('newPassword')} isPassword className="border-0 bg-[#f8f8f8] dark:bg-gray-900" />
        </> : null}
